...
DEFAULT_CHUNKS_PATH = CONFIG["paths"]["knowledge_chunks"]
...
def format_pizza_name(name):
    if name.endswith("pizza"):
        return name
...
def save_chunks_to_json(
    chunks,
    output_path=DEFAULT_CHUNKS_PATH,
):
